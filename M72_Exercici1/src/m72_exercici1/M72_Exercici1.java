...
public class M72_Exercici1 {
	...
	public static void main(String[] args) {
		...
		****
		...
		El nombre de línies formades per "*" vindrà donat per un número que l'™usuari
		introduirà  per consola. Condició: En tot el codi del programa només hi pot
		haver un * També, a poder ser, no utilitzis cap mètode com repeat() o
