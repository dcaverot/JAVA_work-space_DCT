...
public class M4_Exercici5_Switch {
	...
	public static void main(String[] args) {
		/*
		 * Fer un programa que demani dos números i un operador(+,-,*,/). Al final, el
		 * programa ha d'imprimir per pantalla el resultat de fer l’operació que
		 * contingui la variable operador.
		 */
